...
if (isHub) {
  ...
  assert.ok(existsSync(join(root, 'app/docs/layout.tsx')), 'app/docs/layout.tsx missing');
  const catchAll = join(root, 'app/docs/[[...slug]]/page.tsx');
  assert.ok(existsSync(catchAll), 'app/docs/[[...slug]]/page.tsx missing');
