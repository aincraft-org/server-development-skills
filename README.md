...
| [ui-design-router](ui-design-router/SKILL.md) | Player-facing UI decisions: routes design signals — colors and contrast, typography, layout, GUI states, surface conventions — to the matching principle, with deep-dive references under `ui-design-router/references/` |
